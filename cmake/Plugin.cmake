...
find_package(Qt6 REQUIRED Core Gui Widgets Xml Network PrintSupport Test Core5Compat)
...
if (EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/${UGENE_PLUGIN_ID}.qrc)
    qt_add_resources(RCC_SRCS ${CMAKE_CURRENT_SOURCE_DIR}/${UGENE_PLUGIN_ID}.qrc)
endif ()

add_library(${UGENE_PLUGIN_ID} SHARED ${SRCS} ${RCC_SRCS})

set(UGENE_PLUGIN_LIBS
        Qt6::Core Qt6::Core5Compat Qt6::Gui Qt6::Widgets Qt6::Xml Qt6::Network Qt6::PrintSupport Qt6::Test

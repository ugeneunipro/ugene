...
foreach (UGENE_LICENSE_FILE ${UGENE_PLUGIN_LICENSE_FILES})
    set(UGENE_PLUGIN_LICENSE_OUTPUT "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${UGENE_PLUGIN_ID}${UGENE_BUILD_MODE_SUFFIX}.license")
    file(COPY "${UGENE_LICENSE_FILE}" DESTINATION "${UGENE_PLUGIN_LICENSE_OUTPUT}" FILE_PERMISSIONS OWNER_WRITE OWNER_READ GROUP_READ WORLD_READ)
endforeach ()

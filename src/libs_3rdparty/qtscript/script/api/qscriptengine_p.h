...
struct GlobalClientData : public JSC::JSGlobalData::ClientData {
  GlobalClientData(QScriptEnginePrivate *e) : engine(e) {}
...
public:
  ...
  static inline const QMetaObject *toQMetaObject(JSC::ExecState *,
                                                 JSC::JSValue);

  static inline JSC::JSValue
  property(JSC::ExecState *, JSC::JSValue, const JSC::Identifier &id,
           int resolveMode = QScriptValue::ResolvePrototype);
  static JSC::JSValue propertyHelper(JSC::ExecState *, JSC::JSValue,
                                     const JSC::Identifier &id,
                                     int resolveMode);
  static inline JSC::JSValue
  property(JSC::ExecState *, JSC::JSValue, quint32 index,
           int resolveMode = QScriptValue::ResolvePrototype);
  static JSC::JSValue propertyHelper(JSC::ExecState *, JSC::JSValue, quint32,
                                     int resolveMode);
  static inline JSC::JSValue property(JSC::ExecState *, JSC::JSValue,
                                      const JSC::UString &, int resolveMode);
  static inline void setProperty(JSC::ExecState *, JSC::JSValue object,
                                 const JSC::UString &name, JSC::JSValue,
                                 const QScriptValue::PropertyFlags &flags =
                                     QScriptValue::KeepExistingFlags);
  static void setProperty(JSC::ExecState *, JSC::JSValue object,
                          const JSC::Identifier &id, JSC::JSValue,
                          const QScriptValue::PropertyFlags &flags =
                              QScriptValue::KeepExistingFlags);
  static void setProperty(JSC::ExecState *, JSC::JSValue object, quint32 index,
                          JSC::JSValue,
                          const QScriptValue::PropertyFlags &flags =
                              QScriptValue::KeepExistingFlags);
  static QScriptValue::PropertyFlags
  propertyFlags(JSC::ExecState *, JSC::JSValue value, const JSC::Identifier &id,
                const QScriptValue::ResolveFlags &mode);
  static inline QScriptValue::PropertyFlags
  propertyFlags(JSC::ExecState *, JSC::JSValue value, const JSC::UString &name,
                const QScriptValue::ResolveFlags &mode);

  static bool convertValue(JSC::ExecState *, JSC::JSValue value, int type,
                           void *ptr);
  ...
  propertyFlagsToJSCAttributes(const QScriptValue::PropertyFlags &flags);

  static inline JSC::JSValue jscValueFromVariant(JSC::ExecState *,
                                                 const QVariant &value);
  static QVariant jscValueToVariant(JSC::ExecState *, JSC::JSValue value,
                                    int targetType);
  static inline QVariant &variantValue(JSC::JSValue value);
  static inline void setVariantValue(JSC::JSValue objectValue,
                                     const QVariant &value);

  static JSC::JSValue arrayFromStringList(JSC::ExecState *,
                                          const QStringList &lst);
  static QStringList stringListFromArray(JSC::ExecState *, JSC::JSValue arr);

  static JSC::JSValue arrayFromVariantList(JSC::ExecState *,
                                           const QVariantList &lst);
  static QVariantList variantListFromArray(JSC::ExecState *, JSC::JSArray *arr);

  static JSC::JSValue objectFromVariantMap(JSC::ExecState *,
  ...
  static inline const JSC::ExecState *
  frameForContext(const QScriptContext *context);
  ...
  JSC::CallFrame *pushContext(JSC::CallFrame *exec, JSC::JSValue thisObject,
                              const JSC::ArgList &args, JSC::JSObject *callee,
  ...
  // flags that we set on the return value register for native function. (ie
  // when codeBlock is 0)
  enum ContextFlags {
    NativeContext = 1,
  ...
  void uncaughtException(JSC::ExecState *, unsigned bytecodeOffset,
                         JSC::JSValue);
  ...
  static JSC::JSValue newRegExp(JSC::ExecState *, const QString &pattern,
                                const QString &flags);
  ...
  static inline QScriptDeclarativeClass::Object *
      declarativeObject(JSC::JSValue);

  JSC::UString translationContextFromUrl(const JSC::UString &);

#ifndef QT_NO_QOBJECT
  void markQObjectData(JSC::MarkStack &);
  JSC::JSValue newQObject(
      QObject *object,
  ...
  bool scriptConnect(QObject *sender, const char *signal, JSC::JSValue receiver,
  ...
  bool scriptConnect(QObject *sender, int index, JSC::JSValue receiver,
                     JSC::JSValue function, JSC::JSValue senderWrapper,
                     Qt::ConnectionType type);
  bool scriptDisconnect(QObject *sender, int index, JSC::JSValue receiver,
...
public:
  APIShim(QScriptEnginePrivate *engine)
      : m_engine(engine), m_oldTable(JSC::setCurrentIdentifierTable(
                              engine->globalData->identifierTable)) {}
  ~APIShim() { JSC::setCurrentIdentifierTable(m_oldTable); }
...
/*Helper class. Main purpose is to give debugger feedback about unloading and
  loading scripts. It keeps pointer to JSGlobalObject assuming that it is always
  the same - there is no way to update this data. Class is internal and used as
  an implementation detail in and only in QScriptEngine::evaluate.*/
class UStringSourceProviderWithFeedback : public JSC::UStringSourceProvider {
public:
  static PassRefPtr<UStringSourceProviderWithFeedback>
  create(const JSC::UString &source, const JSC::UString &url, int lineNumber,
         QScriptEnginePrivate *engine) {
    return adoptRef(
        new UStringSourceProviderWithFeedback(source, url, lineNumber, engine));
  }

  /* Destruction means that there is no more copies of script so create
     scriptUnload event and unregister script in
     QScriptEnginePrivate::loadedScripts */
  ...
  /* set internal QScriptEnginePrivate pointer to null and create unloadScript
     event, should be called only if QScriptEnginePrivate is about to be
     destroyed.*/
...
protected:
  UStringSourceProviderWithFeedback(const JSC::UString &source,
                                    const JSC::UString &url, int lineNumber,
                                    QScriptEnginePrivate *engine)
      : UStringSourceProvider(source, url), m_ptr(engine) {
    if (JSC::Debugger *debugger = this->debugger())
  ...
  JSC::Debugger *debugger() {
    // if m_ptr is null it mean that QScriptEnginePrivate was destroyed and
    // scriptUnload was called else m_ptr is stable and we can use it as normal
    // pointer without hesitation
    if (!m_ptr)
      return 0; // we are in ~QScriptEnginePrivate
    else
      return m_ptr->originalGlobalObject()
          ->debugger(); // QScriptEnginePrivate is still alive
  }
...
public:
  ...
  ~SaveFrameHelper() { engine->currentFrame = oldFrame; }
...
inline QString ToString(qsreal value) { return JSC::UString::from(value); }
...
inline qint32 ToInt32(const QString &value) { return ToInt32(ToNumber(value)); }
...
inline bool ToBool(qsreal value) { return (value != 0) && !qIsNaN(value); }

inline bool ToBool(const QString &value) { return !value.isEmpty(); }
...
inline void
QScriptEnginePrivate::registerScriptProgram(QScriptProgramPrivate *program) {
  Q_ASSERT(!registeredScriptPrograms.contains(program));
  registeredScriptPrograms.insert(program);
}

inline void
QScriptEnginePrivate::unregisterScriptProgram(QScriptProgramPrivate *program) {
  Q_ASSERT(registeredScriptPrograms.contains(program));
  registeredScriptPrograms.remove(program);
}

inline QScriptValuePrivate *
QScriptEnginePrivate::allocateScriptValuePrivate(size_t size) {
  if (freeScriptValues) {
...
inline void
QScriptEnginePrivate::freeScriptValuePrivate(QScriptValuePrivate *p) {
...
inline void
QScriptEnginePrivate::registerScriptValue(QScriptValuePrivate *value) {
  value->prev = 0;
...
inline void
QScriptEnginePrivate::unregisterScriptValue(QScriptValuePrivate *value) {
  if (value->prev)
...
inline JSC::JSValue
QScriptEnginePrivate::jscValueFromVariant(JSC::ExecState *exec,
                                          const QVariant &v) {
...
inline QScriptValue
QScriptEnginePrivate::scriptValueFromJSCValue(JSC::JSValue value) {
  if (!value)
    return QScriptValue();
...
inline JSC::JSValue
QScriptEnginePrivate::scriptValueToJSCValue(const QScriptValue &value) {
...
inline unsigned QScriptEnginePrivate::propertyFlagsToJSCAttributes(
    const QScriptValue::PropertyFlags &flags) {
  unsigned attribs = 0;
...
inline JSC::JSValue QScriptEnginePrivate::property(JSC::ExecState *exec,
                                                   JSC::JSValue value,
...
inline JSC::JSValue QScriptEnginePrivate::property(JSC::ExecState *exec,
  ...
  if ((resolveMode & QScriptValue::ResolvePrototype) &&
      object->getPropertySlot(exec, id, slot))
...
inline JSC::JSValue QScriptEnginePrivate::property(JSC::ExecState *exec,
  ...
  JSC::PropertySlot slot(object);
  if ((resolveMode & QScriptValue::ResolvePrototype) &&
      object->getPropertySlot(exec, index, slot))
    return slot.getValue(exec, index);
  return propertyHelper(exec, value, index, resolveMode);
}

inline QScriptValue::PropertyFlags
QScriptEnginePrivate::propertyFlags(JSC::ExecState *exec, JSC::JSValue value,
                                    const JSC::UString &name,
                                    const QScriptValue::ResolveFlags &mode) {
  return propertyFlags(exec, value, JSC::Identifier(exec, name), mode);
}

inline void QScriptEnginePrivate::setProperty(
    JSC::ExecState *exec, JSC::JSValue objectValue, const JSC::UString &name,
...
inline JSC::JSValue QScriptValuePrivate::property(
    const JSC::Identifier &id,
    const QScriptValue::ResolveFlags &resolveMode) const {
  return QScriptEnginePrivate::property(engine->currentFrame, jscValue, id,
                                        resolveMode);
}

inline JSC::JSValue QScriptValuePrivate::property(
    quint32 index, const QScriptValue::ResolveFlags &resolveMode) const {
  return QScriptEnginePrivate::property(engine->currentFrame, jscValue, index,
                                        resolveMode);
}
...
inline JSC::JSValue QScriptValuePrivate::property(
  ...
  return QScriptEnginePrivate::property(
      exec, jscValue, JSC::Identifier(exec, name), resolveMode);
}
...
inline QScriptValue::PropertyFlags QScriptValuePrivate::propertyFlags(
  ...
  return QScriptEnginePrivate::propertyFlags(engine->currentFrame, jscValue, id,
                                             mode);
}

inline void
QScriptValuePrivate::setProperty(const JSC::Identifier &id,
                                 const JSC::JSValue &value,
                                 const QScriptValue::PropertyFlags &flags) {
  QScriptEnginePrivate::setProperty(engine->currentFrame, jscValue, id, value,
                                    flags);
}

inline void
QScriptValuePrivate::setProperty(quint32 index, const JSC::JSValue &value,
                                 const QScriptValue::PropertyFlags &flags) {
  QScriptEnginePrivate::setProperty(engine->currentFrame, jscValue, index,
                                    value, flags);
}

inline void
QScriptValuePrivate::setProperty(const JSC::UString &name,
                                 const JSC::JSValue &value,
                                 const QScriptValue::PropertyFlags &flags) {
  JSC::ExecState *exec = engine->currentFrame;
  QScriptEnginePrivate::setProperty(exec, jscValue, JSC::Identifier(exec, name),
                                    value, flags);
}

inline void *QScriptValuePrivate::operator new(size_t size,
                                               QScriptEnginePrivate *engine) {
  if (engine)
...
inline void QScriptEnginePrivate::saveException(JSC::ExecState *exec,
                                                JSC::JSValue *val) {
  if (exec) {
    *val = exec->exception();
    exec->clearException();
...
inline void QScriptEnginePrivate::restoreException(JSC::ExecState *exec,
                                                   JSC::JSValue val) {
  if (exec && val)
...
inline void
QScriptEnginePrivate::registerScriptString(QScriptStringPrivate *value) {
...
inline void
QScriptEnginePrivate::unregisterScriptString(QScriptStringPrivate *value) {
  Q_ASSERT(value->type == QScriptStringPrivate::HeapAllocated);
  if (value->prev)
    value->prev->next = value->next;
  if (value->next)
...
inline QScriptContext *
QScriptEnginePrivate::contextForFrame(JSC::ExecState *frame) {
  if (frame && frame->callerFrame()->hasHostCallFrameFlag() &&
      !frame->callee() &&
      frame->callerFrame()->removeHostCallFrameFlag() ==
          QScript::scriptEngineFromExec(frame)->globalExec()) {
...
inline JSC::ExecState *
QScriptEnginePrivate::frameForContext(QScriptContext *context) {
  return reinterpret_cast<JSC::ExecState *>(context);
}

inline const JSC::ExecState *
QScriptEnginePrivate::frameForContext(const QScriptContext *context) {
  return reinterpret_cast<const JSC::ExecState *>(context);
}

inline bool
QScriptEnginePrivate::hasValidCodeBlockRegister(JSC::ExecState *frame) {
#if ENABLE(JIT)
...
inline JSC::JSValue QScriptEnginePrivate::newArray(JSC::ExecState *exec,
                                                   uint length) {
  return JSC::constructEmptyArray(exec, length);
}

inline JSC::JSValue QScriptEnginePrivate::newDate(JSC::ExecState *exec,
                                                  qsreal value) {
  ...
  if (delegate) {
    if (delegate->type() == QScriptObjectDelegate::QtObject ||
        (delegate->type() == QScriptObjectDelegate::DeclarativeClassObject &&
         static_cast<QScript::DeclarativeObjectDelegate *>(delegate)
             ->scriptClass()
             ->isQObject()))
      return true;
...
#ifndef QT_NO_QOBJECT
  return isObject(value) && JSC::asObject(value)->inherits(
                                &QScript::QMetaObjectWrapperObject::info);
#else
  return false;
#endif
}

inline bool QScriptEnginePrivate::toBool(JSC::ExecState *exec,
                                         JSC::JSValue value) {
...
inline qsreal QScriptEnginePrivate::toInteger(JSC::ExecState *exec,
                                              JSC::JSValue value) {
  JSC::JSValue savedException;
  saveException(exec, &savedException);
...
inline qsreal QScriptEnginePrivate::toNumber(JSC::ExecState *exec,
                                             JSC::JSValue value) {
  JSC::JSValue savedException;
  saveException(exec, &savedException);
...
inline qint32 QScriptEnginePrivate::toInt32(JSC::ExecState *exec,
                                            JSC::JSValue value) {
  JSC::JSValue savedException;
  saveException(exec, &savedException);
...
inline quint32 QScriptEnginePrivate::toUInt32(JSC::ExecState *exec,
                                              JSC::JSValue value) {
  JSC::JSValue savedException;
  saveException(exec, &savedException);
...
inline quint16 QScriptEnginePrivate::toUInt16(JSC::ExecState *exec,
                                              JSC::JSValue value) {
  // ### no equivalent function in JSC
  return QScript::ToUInt16(toNumber(exec, value));
}

inline JSC::UString QScriptEnginePrivate::toString(JSC::ExecState *exec,
                                                   JSC::JSValue value) {
  if (!value)
    return JSC::UString();
  JSC::JSValue savedException;
...
inline QDateTime QScriptEnginePrivate::toDateTime(JSC::ExecState *exec,
                                                  JSC::JSValue value) {
  if (!isDate(value))
    return QDateTime();
  qsreal t =
      static_cast<JSC::DateInstance *>(JSC::asObject(value))->internalNumber();
  return QScript::MsToDateTime(exec, t);
}

inline QObject *QScriptEnginePrivate::toQObject(JSC::ExecState *exec,
                                                JSC::JSValue value) {
#ifndef QT_NO_QOBJECT
  if (isObject(value) && value.inherits(&QScriptObject::info)) {
    QScriptObject *object = static_cast<QScriptObject *>(JSC::asObject(value));
    ...
    if (delegate->type() == QScriptObjectDelegate::DeclarativeClassObject)
      return static_cast<QScript::DeclarativeObjectDelegate *>(delegate)
          ->scriptClass()
          ->toQObject(declarativeObject(value));
    if (delegate->type() == QScriptObjectDelegate::Variant) {
      QVariant var = variantValue(value);
      int type = var.userType();
      if (QMetaType::typeFlags(type) & QMetaType::PointerToQObject)
        return *reinterpret_cast<QObject *const *>(var.constData());
             ...
             value.inherits(&QScript::QScriptActivationObject::info)) {
    QScript::QScriptActivationObject *proxy =
        static_cast<QScript::QScriptActivationObject *>(JSC::asObject(value));
...
QScriptEnginePrivate::toQMetaObject(JSC::ExecState *, JSC::JSValue value) {
#ifndef QT_NO_QOBJECT
  if (isQMetaObject(value))
    return static_cast<QScript::QMetaObjectWrapperObject *>(
               JSC::asObject(value))
        ->value();
#endif
  return 0;
...
inline QScriptDeclarativeClass::Object *
QScriptEnginePrivate::declarativeObject(JSC::JSValue v) {
  if (!QScriptEnginePrivate::isObject(v) || !v.inherits(&QScriptObject::info))
    return 0;
  QScriptObject *scriptObject = static_cast<QScriptObject *>(JSC::asObject(v));
  QScriptObjectDelegate *delegate = scriptObject->delegate();

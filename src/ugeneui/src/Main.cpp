...
#    endif
    ...
    AppContext::getMainWindow()->getDockManager()->registerDock(MWDockArea_Bottom, new TaskViewDockWidget(), ":ugene/images/clock.png", QKeySequence(Qt::ALT | Qt::Key_2));
    ...
    AppContext::getMainWindow()->getDockManager()->registerDock(MWDockArea_Bottom, logView, ":ugene/images/book_open.png", QKeySequence(Qt::ALT | Qt::Key_3));

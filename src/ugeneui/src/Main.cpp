...
#    endif
    ...
    AppContext::getMainWindow()->getDockManager()->registerDock(MWDockArea_Bottom, new TaskViewDockWidget(), IconRef("ugene", "clock.png"), QKeySequence(Qt::ALT | Qt::Key_2));
    ...
    AppContext::getMainWindow()->getDockManager()->registerDock(MWDockArea_Bottom, logView, IconRef("ugene", "book_open.png"), QKeySequence(Qt::ALT | Qt::Key_3));

...
private:
    void prepareMAFromBlastAnnotations(MultipleAlignment& ma, const QString& nameQualId, bool includeRef, U2OpStatus& os);
    void prepareMAFromAnnotations(MultipleAlignment& ma, bool translate, U2OpStatus& os);
    void prepareMAFromSequences(MultipleAlignment& ma, bool translate, U2OpStatus& os);

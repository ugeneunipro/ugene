...
ADVExportContext::ADVExportContext(AnnotatedDNAView* v)
    ...
    annotationsToAlignmentAction = new QAction(GUIUtils::getIconResource("core", "msa.png"), tr("Align selected annotations..."), this);
    ...
    annotationsToAlignmentWithTranslatedAction = new QAction(GUIUtils::getIconResource("core", "msa.png"), tr("Align selected annotations (amino acids)..."), this);
    ...
    sequenceToAlignmentAction = new QAction(GUIUtils::getIconResource("core", "msa.png"), tr("Align selected sequence regions..."), this);
    ...
    sequenceToAlignmentWithTranslationAction = new QAction(GUIUtils::getIconResource("core", "msa.png"), tr("Align selected sequence regions (amino acids)..."), this);

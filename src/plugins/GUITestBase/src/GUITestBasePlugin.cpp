...
void GUITestBasePlugin::registerTests(UGUITestBase *guiTestBase) {
    ...
    REGISTER_TEST_TL(GUITest_common_scenarios_NIAID_pipelines::test_0008, minutes(7), labels({Nightly, Cistrome, Windows, Linux, MacOS}));
    REGISTER_TEST_L(GUITest_common_scenarios_NIAID_pipelines::test_0009, labels({Cistrome, Windows, Linux, MacOS}));
    REGISTER_TEST_TL(GUITest_common_scenarios_NIAID_pipelines::test_0010, minutes(7), labels({Nightly, Cistrome, Linux, MacOS}));

...
void GUITestBasePlugin::registerTests(UGUITestBase *guiTestBase) {
    ...
    REGISTER_TEST_WITH_TIMEOUT(GUITest_common_scenarios_NIAID_pipelines::test_0005, minutes(7));
    REGISTER_TEST_WITH_TIMEOUT(GUITest_common_scenarios_NIAID_pipelines::test_0006, minutes(7));
    /////////////////////////////////////////////////////////////////////////

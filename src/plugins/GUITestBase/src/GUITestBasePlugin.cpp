...
void GUITestBasePlugin::registerTests(UGUITestBase *guiTestBase) {
    ...
    REGISTER_TEST_TL(GUITest_common_scenarios_NIAID_pipelines::test_0005, minutes(7), labels({Cistrome}));
    REGISTER_TEST_TL(GUITest_common_scenarios_NIAID_pipelines::test_0006, minutes(7), labels({Cistrome}));
    /////////////////////////////////////////////////////////////////////////

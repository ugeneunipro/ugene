...
GUI_TEST_CLASS_DEFINITION(test_0002) {
    ...
    GTUtilsDialog::waitForDialog(new PopupChooser({MSAE_MENU_EDIT, "replace_selected_character"}));
...
GUI_TEST_CLASS_DEFINITION(test_0004) {
    ...
    GTUtilsMSAEditorSequenceArea::selectArea(QPoint(9, 9), QPoint(10, 10));

    // 3. Open the context menu in the sequence area.
    // Expected result : the "Edit > Replace character" item is disabled.Selection is in normal mode.
    GTUtilsDialog::waitForDialog(new PopupChecker({MSAE_MENU_EDIT, "replace_selected_character"}, PopupChecker::IsDisabled));
    GTMenu::showContextMenu(GTUtilsMSAEditorSequenceArea::getSequenceArea(0));
}
...
GUI_TEST_CLASS_DEFINITION(test_0006) {
    ...
    // 2. Select one character.
    // Expected result : the character is selected in the normal mode(i.e.borders of the character are drawn using a dashed line).
    GTUtilsMSAEditorSequenceArea::selectArea(QPoint(9, 1), QPoint(9, 1));
...
GUI_TEST_CLASS_DEFINITION(test_0007) {
    ...
    GTUtilsMSAEditorSequenceArea::selectArea(QPoint(9, 8), QPoint(9, 8));
...
GUI_TEST_CLASS_DEFINITION(test_0008) {
    ...
    GTUtilsMSAEditorSequenceArea::clickToPosition(QPoint(41, 9));
...
GUI_TEST_CLASS_DEFINITION(test_0009) {
    ...
    GTUtilsMSAEditorSequenceArea::clickToPosition(QPoint(43, 9));
...
GUI_TEST_CLASS_DEFINITION(test_0010) {
    ...
    GTUtilsMSAEditorSequenceArea::clickToPosition(QPoint(42, 9));
...
GUI_TEST_CLASS_DEFINITION(test_0015) {
    ...
    GTUtilsMSAEditorSequenceArea::selectArea(QPoint(9, 14), QPoint(9, 14));
    ...
    GTUtilsMSAEditorSequenceArea::selectArea(QPoint(9, 13), QPoint(9, 13));
    GTKeyboardUtils::copy();
...
GUI_TEST_CLASS_DEFINITION(test_0017) {
    ...
    GTUtilsNotifications::waitForNotification(true, "It is not possible to insert the character into the alignment.");
    GTKeyboardDriver::keyClick(']');

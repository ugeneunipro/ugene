...
struct IQTreeTaskContext {
    ...
    IQTreeTaskContext(const MultipleAlignment& msa, const CreatePhyTreeSettings& settings);
...
class IQTreeTask : public PhyTreeGeneratorTask {
    Q_OBJECT
public:
    IQTreeTask(const MultipleAlignment& msa, const CreatePhyTreeSettings& settings);

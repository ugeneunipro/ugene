...
IQTreeTaskContext::IQTreeTaskContext(const MultipleAlignment& _msa, const CreatePhyTreeSettings& _settings)
...
IQTreeTask::IQTreeTask(const MultipleAlignment& msa, const CreatePhyTreeSettings& settings)

...
public:
    ...
    /**
     * Extra offset added to all BLAST results.
     * Used to when BLAST results should be applied as annotations to some region of the global sequence.
     */
    int resultRegionOffset;

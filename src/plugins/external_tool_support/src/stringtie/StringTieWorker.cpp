...
void StringTieWorkerFactory::init() {
    QList<PortDescriptor*> ports;
    {
        ...
        Descriptor outPortDesc(OUT_PORT_ID, StringTieWorker::tr("StringTie output data"), StringTieWorker::tr("For each input BAM file the port outputs an URL to a GTF file with assembled transcripts, produced by StringTie. "
    ...
    Descriptor desc(ACTOR_ID, StringTieWorker::tr("Assemble Transcripts with StringTie"), StringTieWorker::tr("StringTie is a fast and highly efficient assembler of RNA-Seq alignments into potential transcripts. "

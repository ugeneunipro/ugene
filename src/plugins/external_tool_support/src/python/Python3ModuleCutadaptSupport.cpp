...
Python3ModuleCutadaptSupport::Python3ModuleCutadaptSupport()
    ...
    if (AppContext::getMainWindow()) {
        icon = IconRef("external_tool_support", "python_cutadapt.png");
        grayIcon = IconRef("external_tool_support", "python_cutadapt_gray.png");
        warnIcon = IconRef("external_tool_support", "python_cutadapt_warn.png");
    }

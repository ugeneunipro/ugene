...
WorkflowView* WorkflowView::createInstance(WorkflowGObject* go) {
    ...
    GUIUtils::setWindowIcon(view, ":/workflow_designer/images/wd.png");
...
void WorkflowView::createActions() {
    ...
    GUIUtils::setThemedIcon<QAction>(runAction, ":workflow_designer/images/run.png");
    ...
    GUIUtils::setThemedIcon<QAction>(stopAction, ":workflow_designer/images/stopTask.png");
    ...
    GUIUtils::setThemedIcon<QAction>(estimateAction, ":core/images/sum.png");
    estimateAction->setObjectName("Estimate workflow");
    ...
    GUIUtils::setThemedIcon<QAction>(pauseAction, ":workflow_designer/images/pause.png");
    ...
    GUIUtils::setThemedIcon<QAction>(showWizard, ":workflow_designer/images/wizard.png");
    ...
    GUIUtils::setThemedIcon<QAction>(loadAction, ":workflow_designer/images/fileopen.png");
    ...
    GUIUtils::setThemedIcon<QAction>(exportAction, ":core/images/cam2.png");
    ...
    GUIUtils::setThemedIcon<QAction>(dmAction, ":workflow_designer/images/settings.png");
    ...
    GUIUtils::setThemedIcon<QAction>(createGalaxyConfigAction, ":workflow_designer/images/galaxy.png");
    ...
    GUIUtils::setThemedIcon<QAction>(copyAction, ":workflow_designer/images/editcopy.png");
    ...
    GUIUtils::setThemedIcon<QAction>(pasteAction, ":core/images/paste.png");
    ...
    GUIUtils::setThemedIcon<QAction>(createScriptAction, ":workflow_designer/images/script.png");
    ...
    GUIUtils::setThemedIcon<QAction>(editScriptAction, ":workflow_designer/images/script_edit.png");
    ...
    GUIUtils::setThemedIcon<QAction>(createCmdlineBasedWorkerAction, ":workflow_designer/images/external_cmd_tool.png");
    ...
    GUIUtils::setThemedIcon<QAction>(editExternalToolAction, ":workflow_designer/images/external_cmd_tool.png");
    ...
    GUIUtils::setThemedIcon<QAction>(appendExternalTool, ":workflow_designer/images/external_cmd_tool_add.png");
...
bool WorkflowView::sl_validate(bool notify) {
    ...
    if (lst.count() != 0) {
        for(QListWidgetItem* wi : qAsConst(lst)) {
            auto ip = wi->data(ICON_DATA_REF).toString();
...
void WorkflowView::setDashboardActionDecoration(bool isDashboardsViewActive) {
    if (isDashboardsViewActive) {
        ...
        GUIUtils::setThemedIcon<QAction>(toggleDashboard, ":workflow_designer/images/wd.png");
        toggleDashboard->setToolTip(tr("Show workflow"));
    } else {
        toggleDashboard->setIconText(tr("Go to Dashboard"));
        GUIUtils::setThemedIcon<QAction>(toggleDashboard, ":workflow_designer/images/dashboard.png");

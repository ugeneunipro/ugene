...
void WorkflowDesignerService::initDesignerAction() {
    ...
    GUIUtils::setThemedIcon<QAction>(designerAction, ":/workflow_designer/images/wd.png");
...
void WorkflowDesignerService::initNewWorkflowAction() {
    ...
    GUIUtils::setThemedIcon<QAction>(newWorkflowAction, ":/workflow_designer/images/wd.png");

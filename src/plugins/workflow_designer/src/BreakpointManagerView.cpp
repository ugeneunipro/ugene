...
void BreakpointManagerView::createActions() {
    ...
    GUIUtils::setThemedIcon<QAction>(newBreakpointAction, IconRef("workflow_designer", "breakpoint.png"));
    ...
    GUIUtils::setThemedIcon<QAction>(highlightItemWithBreakpoint, IconRef("workflow_designer", "highlight_item.png"));

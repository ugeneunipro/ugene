...
ReadAnnotationsProto::ReadAnnotationsProto()
    ...
    auto objNameAttr = new Attribute(annTableNameDesc, BaseTypes::STRING_TYPE(), false, ANN_TABLE_DEFAULT_NAME);
    ...
    if (AppContext::isGUIMode()) {
        setIconParameters(IconParameters("U2Designer", "blue_circle.png", false));
    }
}

...
void QueryViewController::createActions() {
    ...
    GUIUtils::setThemedIcon<QAction>(runAction, IconRef("query_designer", "run.png"));
    ...
    GUIUtils::setThemedIcon<QAction>(loadAction, IconRef("query_designer", "fileopen.png"));
    ...
    GUIUtils::setThemedIcon<QAction>(saveAction, IconRef("query_designer", "filesave.png"));
    ...
    GUIUtils::setThemedIcon<QAction>(saveAsAction, IconRef("query_designer", "filesave.png"));
...
void QueryViewController::setupMDIToolbar(QToolBar* tb) {
    ...
    GUIUtils::setThemedIcon<QToolButton>(tt, IconRef("query_designer", "eye.png"));
    tb->addWidget(tt);
    ...
    GUIUtils::setThemedIcon<QToolButton>(st, IconRef("query_designer", "strands.png"));
    tb->addWidget(st);
...
bool QueryViewController::confirmModified() {
    if (scene->isModified()) {
        ...
        int ret = QMessageBox::question(this, tr("Query Designer"), tr("The schema has been modified.\n"

...
const IconParameters CircularViewSettingsWidgetFactory::GROUP_ICON_PAR = IconParameters("circular_view", "circular.png");
...
QWidget* CircularViewSettingsWidgetFactory::createWidget(GObjectViewController* objView, const QVariantMap& /*options*/) {
    ...
    auto widget = new CircularViewSettingsWidget(ctx->getSettings(annotatedDnaView), cvSplitter);

...
public:
    ...
    U2ErrorType addFlow(const QString& srcElementName, const QString& srcPortName, const QString& dstElementName, const QString& dstPortName);
    ...
    static U2ErrorType createSas(const QString& elementType, const QString& inputFilePath, const QString& outputFilePath, SchemeWrapper** sas);

private:
    U2ErrorType getEnclosingElementBoundaries(const QString& elementName, int* start, int* end) const;
    ...
    U2ErrorType getElementAttributeFromRange(const QString& attributeName, int start, int end, QString& attributeValue);
    ...
    U2ErrorType getUrlInAttributePositionByName(
        const QStringList& attributesHierarchy,
        bool createIfNotExists,
        int* start,
        int* end,

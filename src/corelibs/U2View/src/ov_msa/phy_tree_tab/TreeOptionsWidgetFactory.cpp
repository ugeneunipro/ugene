...
const IconRef MSATreeOptionsWidgetFactory::GROUP_ICON_PAR = IconRef("core", "tree.png");
...
const IconRef TreeOptionsWidgetFactory::GROUP_ICON_PAR = IconRef("core", "tree.png");
...
const IconRef AddTreeWidgetFactory::GROUP_ICON_PAR = IconRef("core", "tree.png");

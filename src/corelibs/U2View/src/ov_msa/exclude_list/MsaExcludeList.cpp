...
void MsaExcludeListContext::initViewContext(GObjectViewController* view) {
    ...
    GUIUtils::setThemedIcon<GObjectViewAction>(toggleExcludeListAction, IconRef("core", "inbox-minus.png"));
    ...
    GUIUtils::setThemedIcon<GObjectViewAction>(moveFromMsaAction, IconRef("core", "arrow-move-down.png"));
...
MsaExcludeListWidget::MsaExcludeListWidget(QWidget* parent, MsaEditor* _msaEditor, MsaExcludeListContext* viewContext)
    ...
    GUIUtils::setThemedIcon<QAction>(moveToMsaAction, IconRef("core", "arrow-move-up.png"));

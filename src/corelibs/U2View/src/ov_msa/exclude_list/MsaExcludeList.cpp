...
void MsaExcludeListContext::initViewContext(GObjectViewController* view) {
    ...
    GUIUtils::setThemedIcon<GObjectViewAction>(toggleExcludeListAction, ":core/images/inbox-minus.png");
    ...
    GUIUtils::setThemedIcon<GObjectViewAction>(moveFromMsaAction, ":core/images/arrow-move-down.png");
...
MsaExcludeListWidget::MsaExcludeListWidget(QWidget* parent, MsaEditor* _msaEditor, MsaExcludeListContext* viewContext)
    ...
    GUIUtils::setThemedIcon<QAction>(moveToMsaAction, ":core/images/arrow-move-up.png");

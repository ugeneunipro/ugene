...
void MsaExcludeListContext::initViewContext(GObjectViewController* view) {
    ...
    GUIUtils::setIcon(toggleExcludeListAction, IconRef("core", "inbox-minus.png"));
    ...
    GUIUtils::setIcon(moveFromMsaAction, IconRef("core", "arrow-move-down.png"));
...
MsaExcludeListWidget::MsaExcludeListWidget(QWidget* parent, MsaEditor* _msaEditor, MsaExcludeListContext* viewContext)
    ...
    GUIUtils::setIcon(moveToMsaAction, IconRef("core", "arrow-move-up.png"));

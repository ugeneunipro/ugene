...
MsaEditorSequenceArea::MsaEditorSequenceArea(MaEditorWgt* _ui, GScrollBar* hb, GScrollBar* vb)
    ...
    GUIUtils::setThemedIcon<QAction>(delColAction, ":core/images/msaed_remove_columns_with_gaps.png");
    ...
    GUIUtils::setThemedIcon<QAction>(removeAllGapsAction, ":core/images/msaed_remove_all_gaps.png");
    ...
    GUIUtils::setThemedIcon<QAction>(toggleSequenceRowOrderAction, ":core/images/collapse.png");
    ...
    GUIUtils::setThemedIcon<QAction>(refreshSequenceRowOrder, ":core/images/collapse_update.png");

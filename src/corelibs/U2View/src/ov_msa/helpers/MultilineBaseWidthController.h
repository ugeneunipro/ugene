...
#ifndef _U2_MULTILINE_BASE_WIDTH_CONTROLLER_H_
#define _U2_MULTILINE_BASE_WIDTH_CONTROLLER_H_
...
class U2VIEW_EXPORT MultilineBaseWidthController : public QObject {
    Q_OBJECT
public:
    MultilineBaseWidthController(MaEditorMultilineWgt *ui);
...
#endif  // _U2_MULTILINE_BASE_WIDTH_CONTROLLER_H_

...
#ifndef _U2_MSA_GRAPH_MULTILINE_OVERVIEW_H_
#define _U2_MSA_GRAPH_MULTILINE_OVERVIEW_H_
...
class MaGraphMultilineOverviewDisplaySettings {
public:
    enum GraphType {
        Hystogram = 0,
        Line = 1,
    ...
    MaGraphMultilineOverviewDisplaySettings()
        : color(Qt::gray),
          type(Area),
...
enum MaGraphMultilineCalculationMethod {
...
class U2VIEW_EXPORT MaGraphMultilineOverview : public MaMultilineOverview {
    Q_OBJECT
public:
    MaGraphMultilineOverview(MaEditorMultilineWgt *ui);
    bool isValid() const {
    ...
    MaGraphMultilineOverviewDisplaySettings::GraphType getCurrentGraphType() const {
        return displaySettings->type;
    }
    MaGraphMultilineOverviewDisplaySettings::OrientationMode getCurrentOrientationMode() const {
        return displaySettings->orientation;
    }
    MaGraphMultilineCalculationMethod getCurrentCalculationMethod() const {
        return method;
    }
...
public slots:
    ...
    void sl_graphOrientationChanged(MaGraphMultilineOverviewDisplaySettings::OrientationMode orientation);
    void sl_graphTypeChanged(MaGraphMultilineOverviewDisplaySettings::GraphType type);
    void sl_graphColorChanged(QColor color);
    void sl_calculationMethodChanged(MaGraphMultilineCalculationMethod method);
...
private:
    ...
    MaGraphMultilineOverviewDisplaySettings *displaySettings;
    MaGraphMultilineCalculationMethod method;
...
#endif  // _U2_MSA_GRAPH_MULTILINE_OVERVIEW_H_

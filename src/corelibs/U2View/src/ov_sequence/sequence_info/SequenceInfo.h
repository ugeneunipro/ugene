...
private:
    ...
    static const char* CAPTION_SEQ_REGION_LENGTH;
    ...
    // nucl
    static const char* CAPTION_SEQ_GC_CONTENT;
    static const char* CAPTION_SEQ_NUCL_MOLECULAR_WEIGHT;
    static const char* CAPTION_SEQ_EXTINCTION_COEFFICIENT;
    static const char* CAPTION_SEQ_MELTING_TEMPERATURE;

    static const QString CAPTION_SEQ_NMOLE_OD;
    static const QString CAPTION_SEQ_MG_OD;

    // amino
    static const char* CAPTION_SEQ_AMINO_MOLECULAR_WEIGHT;
    static const char* CAPTION_SEQ_ISOELECTIC_POINT;

...
void AnnotHighlightWidget::initLayout() {
    ...
    GUIUtils::setThemedIcon<QPushButton>(prevAnnotationButton, ":core/images/backward.png");
    ...
    GUIUtils::setThemedIcon<QPushButton>(prevAnnotationButton, ":core/images/forward.png");

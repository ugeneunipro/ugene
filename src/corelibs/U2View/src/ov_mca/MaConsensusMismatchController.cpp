...
MaConsensusMismatchController::MaConsensusMismatchController(QObject* p,
    ...
    GUIUtils::setThemedIcon<QAction>(nextMismatch, IconRef("core", "mismatch-forward.png"));
    ...
    GUIUtils::setThemedIcon<QAction>(prevMismatch, IconRef("core", "mismatch-backward.png"));

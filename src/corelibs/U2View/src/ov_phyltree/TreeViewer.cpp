...
void TreeViewerUI::updateScene(bool fitSceneToView) {
    ...
    while (!stack.empty()) {
        ...
        double coef = qMax(1.0, TreeViewerUI::SIZE_COEF * getOptionValue(WIDTH_COEF).toUInt());

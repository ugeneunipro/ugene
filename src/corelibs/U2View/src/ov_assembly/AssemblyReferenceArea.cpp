...
void AssemblySequenceArea::connectSlots() {
    ...
    connect(AppContext::getMainWindow(), &MainWindow::si_colorModeSwitched, this, &AssemblySequenceArea::sl_colorModeSwitched);
}
...
void AssemblySequenceArea::sl_colorModeSwitched() {

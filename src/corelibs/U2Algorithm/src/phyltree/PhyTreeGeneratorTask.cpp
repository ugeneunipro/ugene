...
PhyTreeGeneratorTask::PhyTreeGeneratorTask(const MultipleAlignment& ma, const CreatePhyTreeSettings& _settings, const TaskFlags& taskFlags)
...
PhyTreeGeneratorLauncherTask::PhyTreeGeneratorLauncherTask(const MultipleAlignment& ma, const CreatePhyTreeSettings& _settings)

...
public:
    ...
    inline quint32 getPrefixSize() const {
        return w;
    }
    char getUnknownChar() const {
        return unknownChar;
    }
    const quint32* getBitTable() const {
        return bitTable;
    }
...
public:
    ...
    quint32 getBitFilter() const {
        return bitFilter;
    }

    const quint32* getMaskedSequence() const {
        return bitMask;
    }
    const quint32* getSArray() const {
        return sArray;
    }

    quint32 getSArraySize() const {
        return arrLen;
    }

...
class MsaHighlightingSchemeDisagreements : public MsaHighlightingScheme {
    Q_OBJECT
public:
    MsaHighlightingSchemeDisagreements(QObject* parent, const MsaHighlightingSchemeFactory* factory, MsaObject* maObj);

    void process(const char refChar, char& seqChar, QColor& color, bool& hightlight, int refCharColumn, int refCharRow) const override;
};

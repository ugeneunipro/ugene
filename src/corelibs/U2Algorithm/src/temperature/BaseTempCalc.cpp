...
bool BaseTempCalc::isNucleotideSequence(const QByteArray& sequence) {
...
double BaseTempCalc::getMeltingTemperature(const QByteArray& initialPrimer, const QByteArray& alternativePrimer) {
...
const TempCalcSettings& BaseTempCalc::getSettings() const {
    return settings;
}

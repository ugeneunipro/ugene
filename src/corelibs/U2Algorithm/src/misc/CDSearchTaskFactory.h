...
public:
    static QString CDD_DB() {
        return "CDD";
    }
    static QString PFAM_DB() {
        return "Pfam";
    }
    static QString SMART_DB() {
        return "Smart";
    }
    static QString COG_DB() {
        return "Cog";
    }
    static QString KOG_DB() {
        return "Kog";
    }
    static QString PRK_DB() {
        return "Prk";
    }
    static QString TIGR_DB() {
        return "Tigr";
    }
};

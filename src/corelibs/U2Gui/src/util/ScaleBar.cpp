...
ScaleBar::ScaleBar(Qt::Orientation ori, QWidget* parent)
    ...
    GUIUtils::setThemedIcon<QAction>(minusAction, IconRef("core", "minus.png"));
    ...
    GUIUtils::setThemedIcon<QToolButton>(minusButton, IconRef("core", "minus.png"));
    ...
    GUIUtils::setThemedIcon<QAction>(plusAction, IconRef("core", "plus.png"));
    ...
    GUIUtils::setThemedIcon<QToolButton>(plusButton, IconRef("core", "plus.png"));

...
public:
    ...
    Triplet(char c0, char c1, char c2) {
        c[0] = c0;
        c[1] = c1;
        c[2] = c2;
    }
...
public:
    ...
    TripletP(char c0, char c1, char c2) {
        c[0] = c0;
        c[1] = c1;
        c[2] = c2;
        p = 0;
    ...
    TripletP(char c0, char c1, char c2, int p0) {
        c[0] = c0;
        c[1] = c1;
        c[2] = c2;
        p = p0;
...
public:
    ...
    QMap<DNATranslationRole, QList<Triplet>> getCodons() const {
        return roles;
    }

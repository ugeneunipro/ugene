...
REGISTER_TYPE_EX(SEQUENCE, "OT_SEQUENCE", GObject::tr("Sequence"), GObject::tr("Sequences"), "s", IconParameters("core", "dna.png", false), IconParameters("core", "ro_dna.png", false));
...
REGISTER_TYPE_EX(PHYLOGENETIC_TREE, "OT_PTREE", GObject::tr("Tree"), GObject::tr("Trees"), "tr", IconParameters("core", "tree.png", false), IconParameters("core", "ro_tree.png", false));
